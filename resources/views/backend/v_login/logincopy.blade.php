        ...
        <div class="auth-box">
            <div id="loginform">
                <div class="text-center p-t-20 p-b-20">
                    ...
                    <h3 class="mt-3" style="color: #6B73FF; font-weight: bold;">Welcome Back!</h3>
                    <p style="font-size: 14px; color: #555;">Please login to your account</p>
                </div>
                    ...
                    <div class="row border-top border-secondary">
                        <div class="col-12">
                            <div class="form-group text-center mt-3">
                                <button class="btn btn-info mb-2" id="to-recover" type="button"><i class="fa fa-lock m-r-5"></i> Lupa Password?</button>
